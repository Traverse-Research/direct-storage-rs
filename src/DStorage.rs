...
pub mod Direct3D {
    pub mod DirectStorage {
        ...
        impl ::core::cmp::PartialEq for IDStorageQueue2 {
            fn eq(&self, other: &Self) -> bool {
                self.0 == other.0
            }
        }
        impl ::core::cmp::Eq for IDStorageQueue2 {}
        impl ::core::fmt::Debug for IDStorageQueue2 {
            fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                f.debug_tuple("IDStorageQueue2").field(&self.0).finish()
            }
        }
        unsafe impl ::windows_core::Interface for IDStorageQueue2 {
            type Vtable = IDStorageQueue2_Vtbl;
        }
        impl ::core::clone::Clone for IDStorageQueue2 {
            fn clone(&self) -> Self {
                Self(self.0.clone())
            }
        }
        ...
        pub const DSTORAGE_SDK_VERSION: u32 = 201u32;
